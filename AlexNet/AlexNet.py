...
root = '/home/ivpl-d29/myProject/Study_Model/AlexNet/'
now = datetime.now()
timestamp = now.strftime("%Y%m%d-%H%M%S")

log_dir = f'/home/ivpl-d29/myProject/Study_Model/AlexNet/logs/{timestamp}'
...
# 클래스명 출력
train_class_names = get_class_names(os.path.join(root2, 'train'))
val_class_names = get_class_names(os.path.join(root2, 'val'))
test_class_names = get_class_names(os.path.join(root2, 'test'))
