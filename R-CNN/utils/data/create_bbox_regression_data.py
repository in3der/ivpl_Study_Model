...
if __name__ == '__main__':
    ...
    数据集保存在bbox_car目录下
    """
    voc_car_train_dir = '/home/ivpl-d29/dataset/VOC/voc_car/train'
    # ground truth
    gt_annotation_dir = os.path.join(voc_car_train_dir, 'Annotations')
    jpeg_dir = os.path.join(voc_car_train_dir, 'JPEGImages')

    classifier_car_train_dir = '/home/ivpl-d29/dataset/VOC/voc_car/finetune_car/train'
    # positive
    positive_annotation_dir = os.path.join(classifier_car_train_dir, 'Annotations')

    dst_root_dir = '/home/ivpl-d29/dataset/VOC/voc_car/bbox_regression/'
